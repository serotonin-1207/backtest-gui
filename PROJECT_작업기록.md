...
저장소 내 `unittest` 회귀 테스트 24개를 실행: 기존 CAGR·MDD·XIRR·TWR·세금·환율·라오어·참조데이터 검증에 더해 매분기 스케줄, 횡보장 원금 보존, 빠른 XIRR 일치, 경량 라오어와 전체 엔진 일치, 루틴 후보 정렬·차원별 추천 생성을 검증 — **전부 통과**.
