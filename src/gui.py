...
APP_VERSION = "1.13.2 (2026-07-13) — 상단 대시보드에 라오어 V3.0 수익률 추가(거치식·적립식·라오어 3종 비교)"
...
**🇭🇰 항셍테크(중국 기술주) 규제 폭락 — 참고 (실측)**

| 사건 | 고점 → 저점 | 낙폭 | 원인 |
|---|---|---|---|
| 중국 빅테크 규제 | **2021-02 → 2022-10** | 항셍테크 **-75%** · 2배(7226) **-96%** | 알리바바 반독점·게임/사교육 규제·ADR 상장폐지 우려 |

사이드바 **‘항셍테크’ 폭락 버튼**은 이 고점(2021-02-17)부터 현재까지를 잡아줍니다.
자산 선택에서 항셍테크 ETF(3033.HK)나 2배(7226.HK)를 골라 확인하세요. (미국 지수와 시기·성격이 달라 위 그룹 막대차트에는 넣지 않았습니다.)
"""
