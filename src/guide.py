...
<h2>6. 왜 결국 "QQQ(나스닥100)"인가? — 지수 장기 비교</h2>
<p>QQQ·QLD·TQQQ는 모두 <b>나스닥100 지수</b>를 추종합니다(1·2·3배). 그럼 나스닥100이 다른 지수보다 정말 더 올랐을까요?
거치식으로 실측했습니다(배당 제외 가격지수 기준).</p>
<table>
<tr><th>지수</th><th>2010~현재 (배수 / CAGR)</th><th>2015~현재</th><th>MDD</th></tr>
<tr><td>다우존스</td><td>4.97배 / 10.2%</td><td>2.95배 / 9.8%</td><td>-37%</td></tr>
<tr><td>S&P500</td><td>6.67배 / 12.2%</td><td>3.67배 / 11.9%</td><td>-34%</td></tr>
...
<tr><td>필라델피아 반도체</td><td>35.3배 / 24.1%</td><td>18.8배 / 29.0%</td><td class="neg">-47%</td></tr>
</table>

<h3>나스닥100이 앞선 이유</h3>
<ul>
<li><b>기술·성장주 집중</b>: 애플·MS·엔비디아·아마존·구글·메타·테슬라 등 — 지난 15년 <b>이익이 폭발적으로 성장</b>한
플랫폼·반도체 기업이 핵심. 다우(전통 가치주 30개)·S&P500(광범위 500개)은 성장주 비중이 낮아 상대적으로 저조.</li>
<li><b>금융주 제외 + 대형 우량주 100개만</b>: 나스닥100은 나스닥 상장 비금융 대형주 100개. <b>나스닥종합(3천여 개)</b>보다
부실 소형주를 빼고 우량주에 집중해 성과가 더 좋았습니다.</li>
<li><b>승자독식</b>: 빅테크가 이익·현금흐름을 독식하는 구조가 지수 상승을 견인.</li>
</ul>

<div class="warn">
<b>정직한 반전 — "가장 많이 오른 건 QQQ가 아니다"</b>: 실제로 필라델피아 <b>반도체 지수(SOX)가 35배</b>로 나스닥100(15.8배)보다
훨씬 높았습니다! 하지만 SOX는 <b>MDD -47%</b>로 변동성이 크고 <b>반도체 한 섹터에 집중</b>돼 위험이 큽니다.<br>
→ 그래서 대중적 선택은 <b>"충분히 높은 수익 + 상대적 분산(대형 기술주 100개)"</b>의 균형점인 <b>나스닥100(QQQ)</b>이고,
여기에 레버리지를 건 게 <b>QLD·TQQQ</b>입니다. 그래서 "결국 QQQ"로 귀결됩니다.
</div>
<p style="font-size:12px;color:#9aa4bb">※ 지난 15년은 저금리 + 빅테크 전성기였습니다. 금리·산업 국면이 바뀌면 미래엔 다른 지수가 앞설 수 있습니다.</p>
